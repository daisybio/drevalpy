...
from drevalpy.components.contracts import FeatureContract, FeatureKind, normalize_feature_contract
...
def apply_registration_contracts(
    ...
    *,
    ...
    if contract is not None:
        if _contract_defined_on_class(cls, "contract", "output_contract"):
    ...
    if cell_line_contract is not None:
        if _contract_defined_on_class(cls, "cell_line_contract", "required_cell_line_contract"):
    ...
    if drug_contract is not None:
        if _contract_defined_on_class(cls, "drug_contract", "required_drug_contract"):
