...
class CorrelationComparisonScatter:
    def __init__(self, df: pd.DataFrame, color_by: str, metric='Pearson'):
        ...
        self.fig_overall = make_subplots(rows=len(self.models), cols=len(self.models),
    ...
    def __generate_corr_comp_scatterplots__(self):
        ...
        scatterplot = go.Scatter(x=first_df[self.metric],
    ...
    def __draw_subplot__(self, x_df, y_df, run, run2):
        ...
        joint_df.columns = [f'{self.metric}_x', 'model_x', 'setting_x', f'{self.metric}_y', 'model_y',
                            'setting_y']
        ...
        scatterplot = go.Scatter(x=x_df_inter[self.metric],
                                 y=y_df[self.metric],
                                 mode='markers',
