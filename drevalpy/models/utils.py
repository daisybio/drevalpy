...
def load_ge_features_from_landmark_genes(data_path: str, dataset_name: str) -> FeatureDataset:
...
def load_drug_features_from_fingerprints(data_path: str, dataset_name: str) -> FeatureDataset:
    fingerprints = pd.read_csv(f"{data_path}/{dataset_name}/drug_fingerprints/drug_name_to_demorgan_128_map.csv", index_col=0).T
    return FeatureDataset(
        {
