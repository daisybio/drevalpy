...
class Dense(nn.Module):
    ...
    def __init__(self, params, *args, **kwargs):
        ...
        self.hidden_sizes = params.get(
            "stacked_dense_hidden_sizes", [self.number_of_genes + self.num_drug_features, 1024, 512, 256, 64]
        )
        ...
        self.dense_layers = [
            dense_layer(self.hidden_sizes[ind], self.hidden_sizes[ind + 1], self.act_fn, self.dropout).to(self.device)
