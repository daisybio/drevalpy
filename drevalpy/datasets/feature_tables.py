...
def load_generic_csv(dataset_name: str, feature_name: str, index_col=CELL_LINE_IDENTIFIER) -> FeatureDataset:
...
def load_cl_ids_from_csv(dataset_name: str) -> FeatureDataset:
...
def load_tissues_from_csv(dataset_name: str) -> FeatureDataset:
...
def load_cl_ids_and_tissues_from_csv(dataset_name: str) -> FeatureDataset:
    ...
    """
    cl_ids = load_cl_ids_from_csv(dataset_name)
    try:
        cl_ids.add_features(load_tissues_from_csv(dataset_name))
    except KeyError:
        pass
    return cl_ids


def load_drug_ids_from_csv(dataset_name: str) -> FeatureDataset:
...
def load_drug_fingerprint_features(dataset_name: str, fill_na=True, n_bits=128) -> FeatureDataset:
