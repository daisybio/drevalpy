...
REQUIRED_MIRRORS = (
    ...
    "datasets/loading/multiomics.py",
    "datasets/loading/views.py",
    ...
    "components/predictors/feature_dataset_block.py",
    "components/predictors/literature/_feature_dataset_from_batch.py",
    ...
    "components/predictors/single_drug_block.py",
