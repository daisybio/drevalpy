"""Tests for the lightning-free MOLIR omics helpers."""
...
def test_realign_omic_matrix_passes_matching_width_through_unchanged() -> None:
    values = np.array([[1.0, 2.0]])

    result = _realign_omic_matrix(values, ["a", "b"], ["a", "b"])
