...
def test_smilesvec_loader_renames_generated_feature_view(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    loaded = SmilesVecDrugFeaturizer.load_features("TOY")
