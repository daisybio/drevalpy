...
class RandomForestClassification(BaseModel):
    ...
    def train(self):
        ...
        oversampling can be performed to account for class imbalance by specifying the method in the config file.
        """
        ...
        for target in self.data_dict:
            ...
            clf = RandomForestClassifier(random_state=0, n_jobs=self.n_cpus) # initialize classifier
    ...
    def save(self, result_path, best_model_dict):
        ...
        for target in best_model_dict["models"]:
            ...
            if isinstance(target_model, RandomForestClassifier):
