...
def get_cellosaurus_Db(url='ftp://ftp.expasy.org/databases/cellosaurus/cellosaurus.txt') -> pd.DataFrame:
    """
    ...
    cellosarus_df = pd.DataFrame(list(zip(AC, ID, AS, SY, DI, DR, BTO, CLO, SX, CA, OX, CC)))
    cellosarus_df.columns = ['AC', 'ID', 'AS', 'SY', 'DI', 'DR', 'BTO', 'CLO', 'SX', 'CA', 'OX', 'CC']
